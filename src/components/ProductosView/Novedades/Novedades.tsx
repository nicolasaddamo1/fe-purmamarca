...
function Novedades({ name, price, imageUrl }: { name: string, price: string, imageUrl: string }): React.ReactElement {
    return (
        <Link href={"/productos/detalle"} className='group flex flex-col hover:shadow-2xl rounded-xs outline-[#76644c67] outline-2 hover:outline-[#76644c] w-48 hover:scale-105 duration-200'>
