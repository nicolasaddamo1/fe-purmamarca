    ...
    <div className="md:pt-32">
      ...
      <section className="flex flex-col gap-6 md:px-4 py-10">
        <div className="hidden md:block">
          ...
          />
          <div className="flex flex-row justify-left items-center gap-4 bg-red-500 p-4 w-full max-w-[1200px] overflow-x-scroll no-scrollbar">
            ...
            {categories?.map((prod, i) => (
              <div key={i}>
                <Category
                  id={prod.id}
                  name={prod.name}
                  imageUrl={prod.categoryImage ?? ""} // 🔹 fallback
                />
              </div>
            ))}
          </div>
